program ex1016
 integer::Lat,Lon,m,l
 Real::N,J,X(49917),Y(49917),xx(1482),yy(1482),angle, eps, pi, pi2, sum, theta, theta1, thetai, tol, u, v
 
Open(1,file='1999.lis',status='old')
 do i=1,49917
 read(1,'(18x,i2,F5.2,i3,F5.2)',end=23) Lat, N, lon, J
  y(i)= Lat+N/60.0
  x(i)= lon+J/60.0
 enddo
23 close(1)
...
13 close(2)
 ...
 do i=1,49917
 call locpt(x(i), y(i), xx, yy, 1483, l, m)
 if (l >= 0) then
 call pgsci(30)  
 call pgcirc(x(i),y(i),0.01)
 endif
 enddo
