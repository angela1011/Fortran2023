PROGRAM extest
  real :: x(1048576), y(1048576)
  integer :: Sec, N, i, istat
  real :: fxi(1048576),fx(1048576),f(5242882),df,Z(1048576)

  Open(1, file='molly_bring2.txt', status='old')
  ...
  istat = PGOPEN('test_bring2.ps/vcps')  ! PostScript
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0, 1048576.0, -6000.0, 6000.0, 0, 1) ! Adjusted axis range
  call pglab('Time (sec)', 'Amplitude', 'Original Waveform')
  call pgslw(2)
  call pgsci(8)
  call pgline(1048576, x, y)
  
  call FFT(y, x, 1048576, 20)
  fx=y/1048576.0
  fxi=x/1048576.0
  df=1/(1048576*0.0001) 
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0,5000.0,0.0,150.0,0,1) !just,axis
  call pglab('frequency(Hz)','Amplitude','Fourier Transform')
  call pgslw(2)
  call pgsci(11)
  call pgline(524288,f,z) 
