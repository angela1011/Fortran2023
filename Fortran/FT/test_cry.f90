PROGRAM extest
  real :: x(131072), y(131072)
  integer :: Sec, N, i, istat
  real :: fxi(131072),fx(131072),f(65536),df,Z(131072)

  Open(1, file='molly_cry.txt', status='old')
  ...
  istat = PGOPEN('cry_test.ps/vcps')  ! PostScript
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0, 131072.0, -15000.0, 15000.0, 0, 1) ! Adjusted axis range
  call pglab('Time (sec)', 'Amplitude', 'Original Waveform')
  call pgslw(2)
  call pgsci(8)
  call pgline(262144, x, y)
  
  call FFT(y, x, 131072, 17)
  fx=y/131072.0
  fxi=x/131072.0
  df=1/(131072*0.0001) 
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0,5000.0,0.0,800.0,0,1) !just,axis
  call pglab('frequency(Hz)','Amplitude','Fourier Transform')
  call pgslw(2)
  call pgsci(11)
  call pgline(65536,f,z) 
