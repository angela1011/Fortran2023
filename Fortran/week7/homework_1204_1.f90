...
enddo
 ...
 istat=PGOPEN('hw1204_1.ps/vcps')  !PostScript
 ...
 call pgsch(2.0)
 call pgscf(3)
 call pgenv(0.0,50.0,-5.0,12.0,0,1) !just,axis
...
f(i)=i*df
 ...
 call pgsch(2.0)
 call pgscf(3)
 call pgenv(0.0,50.0,0.0,0.002,0,1) !just,axis
 call pglab('frequency(Hz)','Amplitude','Plot Z')
 call pgslw(2)
 call pgsci(2)
