PROGRAM extest
  ...
  Open(1, file='molly_bring.txt', status='old')
  ...
  istat = PGOPEN('test_bring.ps/vcps')  ! PostScript
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0, 262144.0, -5000.0, 5000.0, 0, 1) ! Adjusted axis range
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0,5000.0,0.0,500.0,0,1) !just,axis
