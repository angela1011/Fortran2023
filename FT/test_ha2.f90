PROGRAM extest
  ...
  Open(1, file='molly_ha2.txt', status='old')
  ...
  istat = PGOPEN('ha_test_2.ps/vcps')  ! PostScript
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0, 131072.0, -1500.0, 1500.0, 0, 1) ! Adjusted axis range
  ...
  call pgsch(2.0)
  call pgscf(3)
  call pgenv(0.0,5000.0,0.0,200.0,0,1) !just,axis
